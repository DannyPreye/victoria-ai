    ...
    <div className="flex lg:flex-row flex-col ">
      {currentTab == 0 ? (
        <SectionsMenu
          ...
          sections={
            typeof data?.template?.coverLetter?.sections === "object"
              ? Object?.keys(data?.template?.coverLetter?.sections)
              : []
          }
            ...
            <div className="flex items-center gap-[5px] mt-[9px]">
              ...
              <div className="flex items-center gap-[12px] ">
                {colors.map((item, id) => (
                  ...
                  >
                    {item === currentColor && <GrFormCheckmark color="white" />}
                  </button>
                ))}
              </div>
            </div>
        ...
        {addProfilePics && (
          <div className="grid place-items-center">
            <ProfilePicture
              templateId={id}
              profilePicture={
                data.profilePicture?.data?.attributes?.url as string
              }
            />
          </div>
        )}
...
const SectionsMenu = ({
  ...
  const splitWord = (word: string) => word.replace(/([a-z])([A-Z])/g, "$1 $2");
  return (
