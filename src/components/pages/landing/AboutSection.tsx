        ...
        >
            ...
            <div className='mt-[41px] w-full max-w-[768px] mx-auto  flex flex-col items-center'>
                ...
                <p className='text-gray-600 text-center mt-[20px] font-inter text-[20px] leading-[30px]'>
                    ...
                    summary of the main feature and how it benefits customers.
                    The idea here is to keep it short and direct. If the visitor
                    wishes to learn more they will hit the button.
                </p>
            </div>
