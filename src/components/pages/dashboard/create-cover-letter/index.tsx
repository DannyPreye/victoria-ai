...
const createCoverletterRadiobuttons = [
  ...
  },
  {
    ...
    name: "what_describes_you",
    title:
      "Entering the Workforce After Education, with Some Related Experience",
    description:
...
const CreateCoverLetterPage = ({ plans }: Props) => {
      ...
      if (fileUrl) {
        await toast.promise(
          ...
          },
          {
            ...
            success: "Congratulation! document has been succefully generated",
            error:
              "Something went wrong while trying to generate documents. Please try again",
          }
        );
        setIsLoading(false);
  ...
  return (
    <div>
      ...
      <form onSubmit={formik.handleSubmit} className=" p-[16px] lg:p-[32px]">
        <div
              ...
              <div className="flex  relative flex-col items-center">
                ...
                {fileName ? (
                  ...
                  <div className="font-inter mt-[12px] text-center leading-[20px]  text-[14px] text-gray-500 font-[400]">
                    ...
                    <p className="text-[12px] leading-[18px]">PDF</p>
                  </div>
                )}
              </div>
            </div>
